...
export default function Aside({ burgerMenuExpand, childUrl, userRole }: { burgerMenuExpand: boolean, childUrl: string, userRole: string }) {
    ...
    return (
        ...
        <aside className={`fixed ${toggled ? "lg:w-14" : "lg:w-64"} ${burgerMenuExpand ? "flex" : "hidden"}  p-1 top-0 left-0 h-full z-40  lg:flex flex-col border-r border-border/30 transition-all duration-300`}>
