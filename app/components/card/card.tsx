    ...
    return (
        !statsTile ? (
            <div id={String(id)}
                ...
                className={`${fullWidth ? "w-full" : "w-1/3"} ${className}  group transition-all rounded-sm bg-[#222225]/30 p-4 duration-300 border border-card-primary hover:border-primary/50 relative cursor-pointer`}>
                {hoveredCard === id && (
                    <CardActions
                        id={id}
                        // onMouseEnter={handleMouseEnterTile}
